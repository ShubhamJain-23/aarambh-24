  ...
  return (
    <div className="relative">
      ...
      <div className="text-center text-[18px] md:text-[24px] md:mx-20">
        <p className="my-8"> Aarambh 2024, an 18-day welcome program from June 8th to June 25th 2024, is packed with fun, learning, and celebration. We’ll kick things off with an exciting opening event featuring inspiring leaders and teachers who will get you pumped up to learn and create amazing things. </p>
